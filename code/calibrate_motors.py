...
def main():
    ...
    left_motor  = motor.Motor(const.USE_RPI_GPIO, LEFT_MOTOR_ENABLE , LEFT_MOTOR_PIN_1 , 0)
    right_motor = motor.Motor(const.USE_RPI_GPIO, RIGHT_MOTOR_ENABLE, RIGHT_MOTOR_PIN_1, 0)
