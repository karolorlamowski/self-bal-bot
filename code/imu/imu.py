...
CONFIG       = 0x1A
INT_ENABLE   = 0x38
ACCEL_XOUT_H = 0x3F #ACCEL_XOUT_H = 0x3B
ACCEL_YOUT_H = 0x3D
ACCEL_ZOUT_H = 0x3B #ACCEL_ZOUT_H = 0x3F
GYRO_XOUT_H  = 0x47 #GYRO_XOUT_H  = 0x43
GYRO_YOUT_H  = 0x45
GYRO_ZOUT_H  = 0x43 #GYRO_ZOUT_H  = 0x47
XA_OFFSET_H  = 0x0A #XA_OFFSET_H  = 0x06
YA_OFFSET_H  = 0x08
ZA_OFFSET_H  = 0x06 #ZA_OFFSET_H  = 0x0A
XG_OFFSET_H  = 0x17 #XG_OFFSET_H  = 0x13
YG_OFFSET_H  = 0x15
ZG_OFFSET_H  = 0x13 #ZG_OFFSET_H  = 0x17
